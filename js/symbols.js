...
var SYMBOL_TABLE = [
  { name: 'ACORN',    icon: '\uD83C\uDF30', meaning: 'A windfall arrives when least expected',       test: function(d) { return d.stars && d.age_days && (d.stars / Math.max(d.age_days, 1)) > 0.5; }, trigger: function(d) { return 'Stars-to-age ratio is high (' + d.stars + ' stars in ' + d.age_days + ' days).'; } },
  ...
  { name: 'APPLE',    icon: '\uD83C\uDF4E',  meaning: 'Knowledge carefully tended and offered freely',     test: function(d) { return d.readme_length && d.readme_length > 500; }, trigger: function(d) { return 'README is ' + d.readme_length + ' characters.'; } },
  ...
  { name: 'GRIM',     icon: '\uD83D\uDC80',  meaning: 'The end has come, or is very near',        test: function(d) { return d.days_since_push !== undefined && d.days_since_push > 180; }, trigger: function(d) { return 'No commits in ' + d.days_since_push + ' days.'; } },
  ...
  { name: 'KITE',     icon: '\uD83E\uDE81',  meaning: 'Ambitions written down, reaching toward the sky',              test: function(d) { return d.has_roadmap; }, trigger: function(d) { return 'Roadmap or TODO file detected.'; } },
  ...
  { name: 'SPADE',    icon: '\u2660',         meaning: 'Hard work that will one day bear fruit',         test: function(d) { return d.has_ci; }, trigger: function(d) { return 'CI/CD configuration detected.'; } },
